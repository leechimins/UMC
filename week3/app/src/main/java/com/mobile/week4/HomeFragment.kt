...
import com.mobile.week4.databinding.FragmentHomeBinding
import com.mobile.week4.adapter.BannerVPAdapter
import com.mobile.week4.adapter.PannelVPAdapter
import com.mobile.week4.view_model.SharedViewModel
import com.mobile.week4.viewpager.home.BannerFragment
import com.mobile.week4.viewpager.home.PannelFragment
...
class HomeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        albumRVAdapter.setMyItemPlayClickListener(object : AlbumRVAdapter.MyItemPlayClickListener {
            override fun onPlayClick(album: AlbumDto) {
